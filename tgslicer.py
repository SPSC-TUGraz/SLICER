...
class Slicer:
    ...
    def create_mainframe(self):
        ...
        tt(self.endplusplus, msg='Add 1 sec to end')
        ...
        tt(self.endplus, msg='Add 0.05 sec to end')
        ...
        tt(self.endminus,msg='Remove 0.05 sec from end')
        ...
        tt(self.endminusminus, msg='Remove 1 sec from end')
        ...
        tt(self.startplusplus,msg='Add 1 sec to start')
        ...
        tt(self.startplus,msg='Add 0.05 sec to start')
        ...
        tt(self.startminus,msg='Remove 0.05 sec from start')
        ...
        tt(self.startminusminus,msg='Remove 1 sec from start')
        ...
        # tt(loadwav_button, text='Load the wav file \nyou want to process \nalongside your textgrid file')
        ...
        # tt(loadtg_button, text='Load the textgrid file \nyou want to process \nalongside your wav file')
        ...
        tt(self.add_new_cutout_button,msg='Add and configure \nnew frames you want \nto cut out from the \n textgrid and wav file.')
        ...
        tt(self.min_freq_entry, msg='Minimum Frequency')
        ...
        tt(self.max_freq_entry, msg='Maximum Frequency')
